...
const CompletedTasks = ({ completedTodos, handleToggleComplete, handleEditTodo, handleDeleteTodo, editTodo, editText, setEditText, handleUpdateTodo }) => {
  return (
    <>
            ...
            <Card>
              <CardContent>
                {editTodo?.id === todo.id ? (
                  ...
                  <>
                    <ListItemText primary={todo.title} secondary="Completed" />
                    <CardActions>
                      <Checkbox
